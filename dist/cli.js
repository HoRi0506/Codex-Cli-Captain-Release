...
async function runCli(argv) {
    try {
        ...
        if (parsed.command === 'check-install') {
            ...
            process.stdout.write(`NotebookLM archive: ${result.notebookLmArchiveTargetSummary}\n`);

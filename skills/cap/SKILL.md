...
5. Treat `captain` as the first Foreman receiver for work that entered through this skill.
...
7. Keep worker routing internal. Do not tell the operator to invoke separate public worker skills or slash commands.
